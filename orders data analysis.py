 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 1,
   "id": "4e71daa3-ae5d-4ec5-bd83-8cb8a8e35cfc",
   "metadata": {
    "scrolled": true
   },
   "outputs": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 6,
   "id": "9f95962c-5879-41fe-aef5-bee42fa719af",
   "metadata": {
    "scrolled": true
   },
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Requirement already satisfied: kaggle in c:\\users\\saran\\anaconda3\\lib\\site-packages (1.6.14)\n",
      "Requirement already satisfied: six>=1.10 in c:\\users\\saran\\anaconda3\\lib\\site-packages (from kaggle) (1.16.0)\n",
      "Requirement already satisfied: certifi>=2023.7.22 in c:\\users\\saran\\anaconda3\\lib\\site-packages (from kaggle) (2024.6.2)\n",
      "Requirement already satisfied: python-dateutil in c:\\users\\saran\\anaconda3\\lib\\site-packages (from kaggle) (2.9.0.post0)\n",
      "Requirement already satisfied: requests in c:\\users\\saran\\anaconda3\\lib\\site-packages (from kaggle) (2.32.2)\n",
      "Requirement already satisfied: tqdm in c:\\users\\saran\\anaconda3\\lib\\site-packages (from kaggle) (4.66.4)\n",
      "Requirement already satisfied: python-slugify in c:\\users\\saran\\anaconda3\\lib\\site-packages (from kaggle) (5.0.2)\n",
      "Requirement already satisfied: urllib3 in c:\\users\\saran\\anaconda3\\lib\\site-packages (from kaggle) (2.2.2)\n",
      "Requirement already satisfied: bleach in c:\\users\\saran\\anaconda3\\lib\\site-packages (from kaggle) (4.1.0)\n",
      "Requirement already satisfied: packaging in c:\\users\\saran\\anaconda3\\lib\\site-packages (from bleach->kaggle) (23.2)\n",
      "Requirement already satisfied: webencodings in c:\\users\\saran\\anaconda3\\lib\\site-packages (from bleach->kaggle) (0.5.1)\n",
      "Requirement already satisfied: text-unidecode>=1.3 in c:\\users\\saran\\anaconda3\\lib\\site-packages (from python-slugify->kaggle) (1.3)\n",
      "Requirement already satisfied: charset-normalizer<4,>=2 in c:\\users\\saran\\anaconda3\\lib\\site-packages (from requests->kaggle) (2.0.4)\n",
      "Requirement already satisfied: idna<4,>=2.5 in c:\\users\\saran\\anaconda3\\lib\\site-packages (from requests->kaggle) (3.7)\n",
      "Requirement already satisfied: colorama in c:\\users\\saran\\anaconda3\\lib\\site-packages (from tqdm->kaggle) (0.4.6)\n",
      "Requirement already satisfied: Pandas in c:\\users\\saran\\anaconda3\\lib\\site-packages (2.2.2)\n",
      "Requirement already satisfied: numpy>=1.26.0 in c:\\users\\saran\\anaconda3\\lib\\site-packages (from Pandas) (1.26.4)\n",
      ...
      "Requirement already satisfied: tzdata>=2022.7 in c:\\users\\saran\\anaconda3\\lib\\site-packages (from Pandas) (2023.3)\n",
      "Requirement already satisfied: six>=1.5 in c:\\users\\saran\\anaconda3\\lib\\site-packages (from python-dateutil>=2.8.2->Pandas) (1.16.0)\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 6,
   "id": "c3edd1b1-fe1c-47ad-ae31-69162ced9530",
   "metadata": {
    "scrolled": true
   },
   "outputs": [
    {
     ...
     "text": [
      ...
      "License(s): CC0-1.0\n",
      "Downloading orders.csv.zip to C:\\Users\\saran\\Documents\\SQL & Python\n",
      "\n"
     ]
    },
    {
     ...
     "text": [
      ...
      "100%|##########| 200k/200k [00:00<00:00, 1.52MB/s]\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 4,
   "id": "e5249618-6eca-4abc-bd94-fa83a8616b5c",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 8,
   "id": "d1a92af0-8af5-47a7-be19-bb910a15184d",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 9,
   "id": "39564be7-3552-4555-ad95-491784709a53",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 10,
   "id": "8d8539dc-9658-489d-9af4-ac3ef4732843",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 22,
   "id": "31849c71-45a2-4a3f-9040-b008d4832752",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 29,
   "id": "8396ae6d-2843-4f40-a6d9-8d6dec35791f",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 35,
   "id": "f6efa556-ee8d-4206-93df-b8cacb725dbc",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 38,
   "id": "022c97e9-1452-4e3b-a9d8-6abbcb4e9c6d",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 53,
   "id": "8bc67d9b-199b-4ea1-9302-76cfb99212cd",
   "metadata": {},
   "outputs": [],
   "source": [
    "#load the data into sql server using replace option\n",
    "import sqlalchemy as sal\n",
    "engine = sal.create_engine('mssql://DESKTOP-77MFCAU/master?driver=ODBC+DRIVER+17+FOR+SQL+SERVER')\n",
    "conn=engine.connect()"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 54,
   "id": "e04d2228-117a-4de1-878d-8134afbcd520",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   ...
   "id": "d2c1abe6-b4a7-4b58-a843-82a10357d3e4",
   "metadata": {},
   "outputs": [],
   "source": []
  }
